...
*gl* for Nash solution: intertemporal trade balance must be zero
...
*** couple in agricultural trade costs: pvp deflator * net export:
...
*** mlb 20150324 *** link between permit budget and  emission budget
