...
*' Intertemporal trade balance must be zero (couple in agricultural trade costs). Terms are:
*' 1. foreign assets in 2005
*' 2. sum over all time steps of (time step duration * net exports in this time step):
*'   a) net agricultural exports
*'   b) difference of net exports compared to previous iteration, adjusted for price anticipation
...
*' Quadratic adjustment costs penaliseing deviations of trade volumes from previous iteration.
