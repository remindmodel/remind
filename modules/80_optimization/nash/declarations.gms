...
p80_convNashTaxrevComp_iter(iteration,ttot,all_regi,taxrev80) "tax revenue component relative to GDP per iteration, for diagnosing which tax does not clear between iterations [1]"
