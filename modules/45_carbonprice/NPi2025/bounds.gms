...
*' Add limitation to novel CDR in EUR-region. Note that in case of a different region-resolution, this mechanism is implemented by
*' an implicit quantity target in ./modules/45_carbonprice/NPi2025/datainput.gms to distribute across sub-EUR regions.
