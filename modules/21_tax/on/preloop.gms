...
*** See the equations file for more information on the SE tax. 
*** Parameter datainput needs to happen here because pm_tau_fe_tax is set in this file and not in the datainput file. 
p21_tau_SE_tax(t,regi,"elh2") = pm_tau_fe_tax(t,regi,"indst","feels")
