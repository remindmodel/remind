...
pm_taxrevCO2Sector0(ttot,regi,emi_sectors) = p21_CO2TaxSectorMarkup(regi,emi_sectors) * pm_taxCO2eqSum(ttot,regi) * vm_emiCO2Sector.l(ttot,regi,emi_sectors);
...
p21_taxrevImport0(ttot,regi,trade) = p21_tau_Import(ttot,regi,trade) * pm_pvp(ttot,trade) / pm_pvp(ttot,"good") * vm_Mport.l(ttot,regi,trade);
...
p21_taxrevImport_iter(iteration+1,ttot,regi,trade) = v21_taxrevImport.l(ttot,regi,trade);
