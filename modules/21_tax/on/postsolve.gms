...
p21_taxrevPE0(ttot,regi) = sum(entyPe(enty), p21_tau_pe_tax(ttot,regi,enty) * vm_prodPe.l(ttot,regi,enty));
...
p21_taxrevPE_iter(iteration+1,ttot,regi) = v21_taxrevPE.l(ttot,regi);
