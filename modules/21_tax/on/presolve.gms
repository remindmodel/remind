...
p21_taxrevImport0(ttot,regi,tradePe,tax_import_type_21) =  p21_tau_Import(ttot,regi,tradePe,tax_import_type_21)$sameas(tax_import_type_21, "worldPricemarkup") * pm_pvp(ttot,tradePe) / pm_pvp(ttot,"good") * vm_Mport.l(ttot,regi,tradePe)+
                                                               p21_tau_Import(ttot,regi,tradePe,tax_import_type_21)$sameas(tax_import_type_21, "c02taxmarkup") * pm_taxCO2eqSum(ttot,regi) * p_cintraw(tradePe) * vm_Mport.l(ttot,regi,tradePe) +
              p21_tau_Import(ttot,regi,tradePe,tax_import_type_21)$sameas(tax_import_type_21, "avC02taxmarkup") * abs(pm_taxCO2eqSum(ttot,regi)-sum(regi2, pm_taxCO2eqSum(ttot,regi2))/(card(regi2))) *  p_cintraw(tradePe) * vm_Mport.l(ttot,regi,tradePe);
