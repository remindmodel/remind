...
p21_tau_fuEx_sub(tall,all_regi,all_enty)                            "subsidy path for fuel extraction [T$/TWa]"
...
p21_tau_fe_tax(ttot,all_regi,emi_sectors,all_enty)                  "tax path for final energy [T$/TWa]"
p21_tau_fe_sub(ttot,all_regi,emi_sectors,all_enty)                  "subsidy path for final energy [T$/TWa]"
p21_tax_convergence(ttot,all_regi,all_enty)                         "Tax convergence level for specific regions, year and final energy type  [T$/TWa]"
p21_tax_convergence_rollback(ttot,all_regi,all_enty)                "Tax convergence level for specific regions, year and final energy type in rollback scenario [T$/TWa]"
p21_sub_convergence_rollback(ttot,all_regi,emi_sectors,all_enty)    "Subsidy convergence level for specific regions, year and final energy type in rollback scenario [T$/TWa]"
