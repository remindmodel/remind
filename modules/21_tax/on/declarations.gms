...
pm_tau_fe_tax_bit_st(tall,all_regi,all_in)      "tax path for stationary/buildings_industry final energy"
pm_tau_fe_sub_bit_st(tall,all_regi,all_in)      "subsidy path for stationary/buildings_industry final energy"
...
q21_taxrevFEBuildInd(ttot,all_regi)          "calculation of tax on final energy buildings and industry"
