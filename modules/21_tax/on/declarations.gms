...
pm_tau_ces_tax(ttot,all_regi,all_enty)         "ces production tax to mimic production drain and transformation costs"
...
p21_taxrevCES0(ttot,all_regi,all_enty)           "reference level value of ces production tax"
...
p21_taxrevCES_iter(iteration,ttot,all_regi,all_enty)       "reference level value of ces production tax revenue"
...
v21_taxrevCES(ttot,all_regi,all_enty)           "tax on ces production function"
...
q21_taxrevCES(ttot,all_regi,all_enty)           "calculation of tax on ces production function"
