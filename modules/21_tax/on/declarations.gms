...
p21_taxrevGHG_iter(iteration,ttot,all_regi)                "Difference to tax revenues in last iteration for: GHG emission tax revenue"
p21_taxrevCCS_iter(iteration,ttot,all_regi)                "Difference to tax revenues in last iteration for: CCS tax revenue"
p21_taxrevNetNegEmi_iter(iteration,ttot,all_regi)          "Difference to tax revenues in last iteration for: net-negative emissions tax revenue"
p21_taxrevPE_iter(iteration,ttot,all_regi,all_enty)        "Difference to tax revenues in last iteration for: primary energy tax revenue"
p21_taxrevFE_iter(iteration,ttot,all_regi)                 "Difference to tax revenues in last iteration for: final energy tax revenue"
p21_taxrevCES_iter(iteration,ttot,all_regi,all_in)         "Difference to tax revenues in last iteration for: ces production tax revenue"
p21_taxrevResEx_iter(iteration,ttot,all_regi)              "Difference to tax revenues in last iteration for: resource extraction tax revenue"
p21_taxrevPE2SE_iter(iteration,ttot,all_regi)              "Difference to tax revenues in last iteration for: pe2se technologies tax revenue"
p21_taxrevTech_iter(iteration,ttot,all_regi)               "Difference to tax revenues in last iteration for: technology specific new capacity subsidies or taxes revenue"
p21_taxrevXport_iter(iteration,ttot,all_regi)              "Difference to tax revenues in last iteration for: exports tax revenue"
p21_taxrevSO2_iter(iteration,ttot,all_regi)                "Difference to tax revenues in last iteration for: SO2 tax revenue"
p21_taxrevBio_iter(iteration,ttot,all_regi)                "Difference to tax revenues in last iteration for: bioenergy tax revenue"
p21_implicitDiscRate_iter(iteration,ttot,all_regi)         "Difference to tax revenues in last iteration for: implicit tax on energy efficient capital"
p21_taxrevFlex_iter(iteration,ttot,all_regi)               "Difference to tax revenues in last iteration for: flexibility tax revenue"
p21_taxrevImport_iter(iteration,ttot,all_regi,all_enty)    "Difference to tax revenues in last iteration for: import tax"
