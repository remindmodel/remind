...
Parameter
f_uedemand_build(tall,all_regi,all_demScen,all_in)   "useful energy demand in buildings"
/
$ondelim
...
/
;
p36_uedemand_build(ttot,regi,in) = f_uedemand_build(ttot,regi,"%cm_demScen%",in);
