...
* markup cost on heat pumps electricity of 200 USD/MWh(el)
p36_CESMkup(t,regi,"feelhpb") = 200 * sm_TWa_2_MWh * 1e-12;
* place markup cost on district heating of 25 USD/MWh(heat)
...
$ifThen.CESMkup not "%cm_CESMkup_build%" == "standard" 
  p36_CESMkup(t,regi,in)$(p36_CESMkup_input(in)) = / %cm_CESMkup_build% /;
$endIf.CESMkup
