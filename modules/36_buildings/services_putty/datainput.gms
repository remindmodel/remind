...
p36_logitLambda(regi,in)$inViaEs_dyn36(in) = cm_priceSensiBuild;
...
Execute_Load 'input_ref'  p36_cesIONoRebound_putty = vm_cesIOdelta.L;
);
...
$ifthen "%cm_pushCalib%" == "none" 
$elseif "%cm_pushCalib%" == "hydrogen"
