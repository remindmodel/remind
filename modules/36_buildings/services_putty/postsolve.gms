...
p36_fePrice(t,regi_dyn36(regi),fete(entyFe,te))$(abs (qm_budget.m(t,regi)) gt sm_eps) = abs ( qm_balFe.m(t,regi,entySe,entyFe,te)) / abs (qm_budget.m(t,regi));
);
p36_fePrice_iter(iteration,t,regi_dyn36(regi),fete(entyFe,te))$ p36_fePrice(t,regi,entyFe,te)  = p36_fePrice(t,regi,entyFe,te);
