...
p50_delTimp(tall,tall2,regi)$(tall.val ge 2005 and tall.val le 2300)=pm_regionalTemperatureImp(tall,tall2,regi)-pm_regionalTemperatureImp(tall,tall2-1,regi);
p50_delTimp2(tall,tall2,regi)$(tall.val ge 2005 and tall.val le 2300)=pm_regionalTemperatureImp(tall,tall2-1,regi)-pm_regionalTemperatureImp(tall,tall2-2,regi);
...
p50_seImp(tall,tall2,regi)$(tall.val ge 2005 and tall.val le 2300 and tall2.val ge 2005 and tall2.val le 2300) = 
	...
	+p50_var_b1*p50_delTimp(tall,tall2,regi)*p50_delTimp(tall,tall2,regi)*pm_regionalTemperatureImp(tall,tall2-1,regi)**2
	+ p50_var_b2*p50_delTimp2(tall,tall2,regi)*p50_delTimp2(tall,tall2,regi)*pm_regionalTemperatureImp(tall,tall2-1,regi)**2
	+ 2*(p50_cov_a1_a2*p50_delTimp(tall,tall2,regi)*p50_delTimp2(tall,tall2,regi)
	+ p50_cov_a1_b1*p50_delTimp(tall,tall2,regi)*p50_delTimp(tall,tall2,regi)*pm_regionalTemperatureImp(tall,tall2-1,regi)
	+ p50_cov_a1_b2*p50_delTimp(tall,tall2,regi)*p50_delTimp2(tall,tall2,regi)*pm_regionalTemperatureImp(tall,tall2-1,regi)
	+ p50_cov_a2_b1*p50_delTimp(tall,tall2,regi)*p50_delTimp2(tall,tall2,regi)*pm_regionalTemperatureImp(tall,tall2-1,regi)
	+ p50_cov_a2_b2*p50_delTimp2(tall,tall2,regi)*p50_delTimp2(tall,tall2,regi)*pm_regionalTemperatureImp(tall,tall2-1,regi)
	+ p50_cov_b1_b2*p50_delTimp(tall,tall2,regi)*p50_delTimp2(tall,tall2,regi)*pm_regionalTemperatureImp(tall,tall2-1,regi)**2
	)
);
...
pm_damageGrowthRateImp(tall,tall2,regi) = 0;
...
pm_damageGrowthRateImp(tall,tall2,regi)$(tall.val ge 2005 and tall.val le 2300 and tall2.val ge tall.val and tall2.val le 2300) =
(    p50_damageFuncCoefa1 * p50_delTimp(tall,tall2,regi)
  + p50_damageFuncCoefa2 * p50_delTimp2(tall,tall2,regi)
  + p50_damageFuncCoefb1 * p50_delTimp(tall,tall2,regi)*pm_regionalTemperatureImp(tall,tall2-1,regi)
  + p50_damageFuncCoefb2 * p50_delTimp2(tall,tall2,regi)*pm_regionalTemperatureImp(tall,tall2-1,regi)
  - p50_seImp(tall,tall2,regi)**0.5*cm_damage_KWSE
);

*no damages before 2020
pm_damageGrowthRate(tall,regi)$(tall.val le 2020) = 0;
pm_damageGrowthRateImp(tall,tall2,regi)$(tall.val le 2020) = 0;
