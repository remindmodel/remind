...
$offlisting
$ondelim
$include "./modules/40_techpol/NDC/input/f40_NDC+REN21+CHN_NUC.cs3r"
$offdelim
$onlisting
;
...
*** windoffshore-todo
*** allow input data with either "wind" or "pewin" until mrremind is updated 
p40_TechBound(ttot,all_regi,"pewin") $ (p40_TechBound(ttot,all_regi,"pewin") eq 0) = f40_TechBound(ttot,all_regi,"%cm_NDC_version%","wind");
...
*** In scenarios with regional limits to total bioenergy production
*** switch-off biomass capacity targets of NDC
