...
loop(regi,
       if( ( pm_gdp("2010",regi)/pm_pop("2010",regi) ) > 3,
             vm_capEarlyReti.lo("2030",regi,te)$(sameas(te,"pc") OR sameas(te,"coalchp") OR sameas(te,"igcc")) = min(vm_capEarlyReti.l("2020",regi,te)+ 10 * pm_regiEarlyRetiRate(regi,te) - 0.001, 0.9);
             vm_capEarlyReti.lo("2020",regi,te)$(sameas(te,"pc") OR sameas(te,"coalchp") OR sameas(te,"igcc")) = min(vm_capEarlyReti.l("2010",regi,te)+ 10 * pm_regiEarlyRetiRate(regi,te) - 0.001, 0.8);
        else
             vm_capEarlyReti.lo("2030",regi,te)$(sameas(te,"pc") OR sameas(te,"coalchp") OR sameas(te,"igcc")) = min(vm_capEarlyReti.l("2020",regi,te)+ 10 * pm_regiEarlyRetiRate(regi,te) - 0.001, 0.5);
             vm_capEarlyReti.lo("2020",regi,te)$(sameas(te,"pc") OR sameas(te,"coalchp") OR sameas(te,"igcc")) = min(vm_capEarlyReti.l("2010",regi,te)+ 10 * pm_regiEarlyRetiRate(regi,te) - 0.001, 0.8);
          );
     );
