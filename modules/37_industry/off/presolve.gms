...
*** SOF ./modules/37_industry/off/presolve.gms

*** zero out a ghost
vm_macBase.fx(ttot,regi,emiInd37) = 0;

*' Cement (clinker) production causes process CO~2~ emissions of about 
*' 0.5 t CO~2~ per tonne of clinker.  As cement prices are of the magnitude of 
*' 100 US\$/t, CO~2~ pricing (on the scale of 100--1000 US\$/t) will lead to 
*' significant price markups and thus demand response.
...
*** EOF ./modules/37_industry/off/presolve.gms
