...
o37_demFeIndSub(ttot,regi,entySe,entyFe,secInd37,emiMkt) = sum( fe2ppfEn37(entyFe,in), p37_shIndFE(regi,in,secInd37)) * vm_demFeSector.l(ttot,regi,entySe,entyFe,"indst",emiMkt);
