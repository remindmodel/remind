...
***  display "CO2 price applied for Cement Demand Reduction [$/tC], check for co2cement:", p_priceCO2forMAC;
  ...
  * sm_dMAC;
  ...
  pm_CementAbatementPrice(ttot,regi)$( ttot.val ge 2005 )
  = ( (1 - pm_macAbatLev(ttot,regi,"co2cement")) * p_priceCO2forMAC(ttot,regi,"co2cement")
