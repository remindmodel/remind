...
***q37_plasticWaste_firstTimestep(ttot,all_regi,all_enty,all_enty,all_emiMkt)  "calculate carbon contained in plastic waste for first 2 timesteps [GtC]"
  q37_plasticWaste_until2060(ttot,all_regi,all_enty,all_enty,all_emiMkt)  "calculate carbon contained in plastic waste [GtC]"
  q37_plasticWaste_from2060(ttot,all_regi,all_enty,all_enty,all_emiMkt)  "calculate carbon contained in plastic waste [GtC]"
