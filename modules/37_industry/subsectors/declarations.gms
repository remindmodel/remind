...
Parameters
  ...
  pm_NonFos_IndCC_fraction0(ttot,all_regi,secInd37)                            "share of fuel co2 captured that is from sebio or sesyn [fraction], by secInd37"
  pm_NonFos_IndCC_fraction_Emi0(ttot,all_regi,emiInd37)                        "share of fuel co2 captured that is from sebio or sesyn [fraction], by secInd37"
