...
*** check biogenic and synthetic carbon in feedstocks that generate negative
*** emissions
p37_CarbonFeed_CDR(t,regi,emiMkt)
...
p37_IndFeBal_FeedStock_LH(ttot,regi,entyFE,emiMkt)
...
p37_IndFeBal_FeedStock_RH(ttot,regi,entyFE,emiMkt)
...
p37_EmiEnDemand_NonEnCorr(t,regi)
  = sum(emiMkt,
