...
q37_limit_secondary_steel_share(t,regi)$( t.val ge cm_startyear AND ((pm_fedemand(t,regi,"ue_steel_primary") ge 1e-4) AND
                                                                     (pm_fedemand(t,regi,"ue_steel_secondary") ge 1e-4) ) 
                                                                AND cm_emiscen ne 1) ..
