...
*** SOF ./modules/33_carbonRemoval/module.gms

*' @title carbonRemoval
*'
*' @description The 33_carbonRemoval module adds further options to remove CO2 from the atmosphere beyond BECCS
...
$Ifi "%carbonRemoval%" == "portfolio" $include "./modules/33_carbonRemoval/portfolio/realization.gms"
*###################### R SECTION END (MODULETYPES) ############################
*** EOF ./modules/33_carbonRemoval/module.gms
