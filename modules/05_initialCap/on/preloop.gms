...
if (cm_startyear eq 2005,
  ...
  p37_specFeDem("2005",regi,"fesos","bf","standard") = pm_fedemand('2005',regi,'feso_steel')         * sm_EJ_2_TWa / v37_outflowPrc.l('2005',regi,'bf','standard');
  p37_specFeDem("2005",regi,"fehos","bf","standard") = pm_fedemand('2005',regi,'feli_steel')         * sm_EJ_2_TWa / v37_outflowPrc.l('2005',regi,'bf','standard');
  p37_specFeDem("2005",regi,"fegas","bf","standard") = pm_fedemand('2005',regi,'fega_steel')         * sm_EJ_2_TWa / v37_outflowPrc.l('2005',regi,'bf','standard');
  !!p37_specFeDem("2005",regi,"feh2s","bf","standard") = pm_fedemand('2005',regi,'feh2_steel')         * sm_EJ_2_TWa / v37_outflowPrc.l('2005',regi,'bf','standard');
  p37_specFeDem("2005",regi,"feels","bf","standard") = pm_fedemand('2005',regi,'feel_steel_primary') * sm_EJ_2_TWa / v37_outflowPrc.l('2005',regi,'bf','standard');

  p37_specFeDem("2005",regi,"feels","eaf","sec") = pm_fedemand('2005',regi,'feel_steel_secondary') * sm_EJ_2_TWa / v37_outflowPrc.l('2005',regi,'eaf','sec');
