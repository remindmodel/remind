...
*** SOF ./modules/39_carbonUtilization/module.gms

*' @title carbonUtilization
*'
*' @description  The 39_carbonUtilization module includes the possibliity to use synthetic gas and liquids. Synthetic gases and liquids
...
$Ifi "%carbonUtilization%" == "off" $include "./modules/39_carbonUtilization/off/realization.gms"
$Ifi "%carbonUtilization%" == "on" $include "./modules/39_carbonUtilization/on/realization.gms"
*######################## R SECTION END (MODULETYPES) ###############################


*** EOF ./modules/39_carbonUtilization/module.gms
