...
*** RoSa: The last one should be pretending that there is 100 PJ of Manure available in each region.
...
p30_datapebio(regi,"pemanure","5","maxprod",ttot)$(ttot.val ge 2005) = 100 * sm_EJ_2_TWa / 1000;  
