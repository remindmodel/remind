...
p02_inconvpen_lap(ttot,regi,"coaltr")$(ttot.val ge 2005)      = s_D2005_2_D2017 * 0.5;   !! In dollar per GJ seprod at 1.000$/cap GDP, or 10$/GJ at 10.000$_GDP/cap
p02_inconvpen_lap(ttot,regi,"biotr")$(ttot.val ge 2005)       = s_D2005_2_D2017 * 1.0;   !! In dollar per GJ seprod
p02_inconvpen_lap(ttot,regi,"biotrmod")$(ttot.val ge 2005)    = s_D2005_2_D2017 * 0.25;    !! In dollar per GJ seprod. Biotrmod is a mix of wood stoves and automated wood pellets for heating, which has lower air pollution and other discomfort effects
...
p02_inconvpen_lap(ttot,regi,"coalftrec")$(ttot.val ge 2005)   = s_D2005_2_D2017 * 0.9;    !! In dollar per GJ seprod
p02_inconvpen_lap(ttot,regi,"coalftcrec")$(ttot.val ge 2005)  = s_D2005_2_D2017 * 0.9;    !!  equivalent to 4$/GJ at 40.000$_GDP/cap, or 10$/GJ at 100.000$_GDP/cap
p02_inconvpen_lap(ttot,regi,"coalgas")$(ttot.val ge 2005)     = s_D2005_2_D2017 * 0.9;
p02_inconvpen_lap(ttot,regi,"coalh2")$(ttot.val ge 2005)      = s_D2005_2_D2017 * 0.9;
p02_inconvpen_lap(ttot,regi,"coalh2c")$(ttot.val ge 2005)     = s_D2005_2_D2017 * 0.9;
