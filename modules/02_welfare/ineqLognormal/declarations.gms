...
v02_distrNew_sigma2(ttot,all_regi)                    "sigma^2 parameter of lognormal distribution after costs"
...
q02_relConsLoss(tall,all_regi)                    "relative consumption loss w.r.t. reference run"
q02_distrNormalization(tall,all_regi)             "normalization parameter for distribution of costs"
q02_distrNew_SecondMom(tall,all_regi)             "Second moment of distribution after subtracting costs"
q02_distrNew_mu(ttot,all_regi)                        "mu parameter of lognormal distribution after costs"
q02_distrNew_sigma2(ttot,all_regi)                    "sigma^2 parameter of lognormal distribution after costs"
