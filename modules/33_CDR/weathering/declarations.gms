...
p33_weathering_fedem(all_enty)         "specific energy demand for enhanced weathering [EJ per Gt of ground rock]"
...
positive variables
v33_weathering_onfield(ttot,all_regi,rlf,rlf)         "amount of ground rock spread on fields in each timestep [Gt]"
v33_weathering_onfield_tot(ttot,all_regi,rlf,rlf)     "total amount of ground rock on fields [Gt]"
;
...
q33_capconst_weathering(ttot,all_regi)                 "calculates amount of ground rock spread on fields"
q33_weathering_onfield_tot(ttot,all_regi,rlf,rlf)      "calculates total amount of ground rock on fields"
