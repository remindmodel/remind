...
*** Biochar
vm_biocharRevenue(ttot, all_regi)                    "Additional revenue from use of biochar [tril$]"
*** model dynamics
...
q33_biocharRevenue(ttot,all_regi)                      "calculates revenue from biochar use, biochar-price x quantity"
