...
p48_CO2eqwoLU_goal(p48_NDCyearSet(ttot,regi)) =
          p48_2005shareTarget(ttot,regi)     * p48_BAU_reg_emi_wo_LU_bunkers("2005",regi) * p48_factorTargetyear(ttot,regi)    !! share with NDC target
