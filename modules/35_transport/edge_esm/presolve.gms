...
if( (ord(iteration) le 25 and ord(iteration) ge cm_startIter_EDGET and (mod(ord(iteration), 3) eq 0))
    ...
    pm_esCapCost(t,regi,teEs_dyn35)$(t.val gt 2010 AND t.val ge cm_startyear AND t.val le 2100) = p35_esCapCost(t,regi,"%cm_GDPscen%","%cm_demScen_t%","%cm_EDGEtr_scen%",teEs_dyn35);
    ...
    p35_fe2es(t,regi,"%cm_GDPscen%","%cm_demScen_t%","%cm_EDGEtr_scen%",teES_dyn35)$( t.val gt 2005 ) 
    = p35_fe2es_aux(t,regi,"%cm_GDPscen%","%cm_demScen_t%","%cm_EDGEtr_scen%",teES_dyn35);
    ...
    pm_shFeCes(t,regi,entyFe,ppfen_dyn35,teEs_dyn35)$(p35_shFeCes(t,regi,"%cm_GDPscen%","%cm_demScen_t%","%cm_EDGEtr_scen%",entyFe,ppfen_dyn35,teEs_dyn35) AND t.val gt 2010 AND t.val ge cm_startyear AND t.val le 2100) = p35_shFeCes(t,regi,"%cm_GDPscen%","%cm_demScen_t%","%cm_EDGEtr_scen%",entyFe,ppfen_dyn35,teEs_dyn35);
);
$endif.calibrate
