...
$ifthen.transpmodule "%transport%" == "edge_esm"
  p29_trpdemand(tall,all_regi,all_GDPscen,all_demScen_t,EDGE_scenario_all,all_in) "transport demand for the edge_esm transport module, unit: trillion passenger/ton km"
$endif.transpmodule
