...
*'
*'If you are calibrating a new CES structure (added/removed branches to/from the CES tree), you will also maybe need
*'
*'    to adjust the value of cm_CES_calibration_default_prices, which serves fallback prices.
*'
