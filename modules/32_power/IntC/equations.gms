...
*** Flexibility tax is switched on only if cm_flex_tax = 1 and is active from 2025 onwards. 
*** It only affects regions in regi_flexTax.
q32_flexAdj(t,regi,te)$(teFlexTax(te) AND regi_flexTax(regi))..
