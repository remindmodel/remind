...
parameters
    ...
    p32_phaseInElh2cap(ttot)                        "phase-in factor for electrolysis capacities built from stored VRE electricity, scale up from 2030 to 2040"
...
equations
    ...
    q32_elh2capfromTestor(tall,all_regi)            "calculate capacities of dummy seel-->h2 technology from storXXX technologies"
