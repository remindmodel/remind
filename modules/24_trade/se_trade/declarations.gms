...
vm_tradeBudget_Xporter(ttot,all_regi)       "Export budget of regions - only used in capacity realization."
vm_tradeBudget_Mporter(ttot,all_regi)       "Import budget of regions - only used in capacity realization."
;
