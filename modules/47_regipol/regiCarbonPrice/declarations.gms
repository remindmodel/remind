...
Parameter
	...
	p47_slope_beforeTarget_regi(ext_regi)	  "helper parameter to hold regions to which second slope adjustment before Target should apply"
	p47_slope_beforeTarget_allregi(ttot,all_regi)	"helper parameter to define slope before target parameter over all_regi"
