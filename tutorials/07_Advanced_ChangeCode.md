...
The automated tests do not contain a full run of the model by default. If you do larger or more complex changes which could affect the model output, you should also do runs to compare the output of the model with and without your changes.
