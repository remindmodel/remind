...
*' * (1): run until solution is sufficiently converged: default tolerance, for quick solution, not recommended in production runs.
*' * (2): run until solution is sufficiently converged: fine tolerance (0.2x option 1), for production runs.
*' * (3): run until solution is sufficiently converged: coarse tolerance (2x option 1), do not use in production runs!
*'
parameter
