...
```{r}
showAreaAndBarPlotsPlus(data, "Resources|Land Cover Change|Forest|Managed Forest", scales = "fixed")
```
...
```{r}
showAreaAndBarPlotsPlus(data, "Nutrition|Dietary Composition|Livestock Share", scales = "fixed")
```
