...
write.csv2(data,file=paste0(folder,"/REMIND_generic_withoutPlus",date,".csv"),row.names=F,quote=F)
write.csv2(mifs,file=paste0(folder,"/REMIND_mifs_withoutPlus",date,".csv"),row.names=F,quote=F)
