...
# 
#   scale_y_continuous("Electricity Share (%)", 
#                      sec.axis = sec_axis(~ . * plot.price.scale / 100, 
#                                                        name = paste0("Cost of Electricity\n", 
#                                                                      5*rollmean.step,"-year mov. Avg. \n",
#                                                                      "(2015USD/MWh)")))
...
ggsave(plot = p.emi.transp,
       filename =  paste0(plots.path, "/Transport_Emi.png"),
       width=20, height=10, units="cm")
