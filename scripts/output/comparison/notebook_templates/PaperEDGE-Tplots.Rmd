...
legend_ord_modes <- c("Freight Rail", "Truck", "Shipping", "International Shipping", "Domestic Shipping",  "Trucks", "Motorbikes", "Small Cars", "Large Cars", "Van",
                ...
                "Freight", "LDV", "LDV-BEV", "LDV-PHEV", "LDV-ICE", "LDV-FCEV", "Pass non LDV", "Freight (Inland)", "Inland Freight", "Pass non LDV (Domestic)", "Inland non-LDV", "Non motorized")
...
kayapf = function(dtES, dtFE, dtEmi, rp, mapping){
    ...
    dt[, variable := ifelse(variable == "FEcapindex", "C) FE per capita", variable)]
    dt[, variable := ifelse(variable == "EScapindex", "A) ES per capita", variable)]
    dt[, variable := ifelse(variable == "eintindex", "B) Emission intensity", variable)]
    dt[, variable := ifelse(variable == "shareindex", "D) LDVs share", variable)]
    dt[, variable := factor(variable, levels = c("A) ES per capita", "B) Emission intensity", "C) FE per capita", "D) LDVs share"))] 
    p = ggplot()+
