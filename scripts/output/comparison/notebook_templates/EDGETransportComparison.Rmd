...
mapping_scens_paper = data.table(scenario = c("Budg1100_ConvCase", "Budg1100_ElecEra", "Budg1100_HydrHype", "Budg1100_SynSurge", "NDC_ConvCase", "NPi", "Budg1100_ConvCaseWise", "Budg1100_ElecEraWise"), scen_name = c("Budg_IC", "Budg_BE", "Budg_FC", "Budg_ICsyn", "NDC_IC", "NPi_IC", "Budg_IC-LS", "Budg_BE-LS"))
...
psec = ggplot()+
  geom_line(data = dtsec, aes(x = gdpcap, y = demsec, color = region, group = region, linetype = scenario))+
  geom_point(data = dtsec[year %in% c("2020", "2030", "2050", "2070", "2100")], aes(x = gdpcap, y = demsec, shape = year, group = region, color = region))+
...
pappl = ggplot()+
  geom_line(data = dtappl, aes(x = gdpcap, y = demappl, color = region, group = region, linetype = scenario))+
...
ptype = ggplot()+
  geom_line(data = dttype, aes(x = gdpcap, y = demtype, color = region, group = region, linetype = scenario))+
...
psectime = ggplot()+
  geom_line(data = dtsec, aes(x = year, y = demsec, color = region, group = region, linetype = scenario))+
  facet_wrap(~sector, scales = "free") +
  theme2use +
  theme(axis.text.x = element_text(angle = 90, hjust = 1),
        title = element_text(size=8),
...
pappltime = ggplot()+
  geom_line(data = dtappl, aes(x = year, y = demappl, color = region, group = region, linetype = scenario))+
  facet_wrap(~appl, scales = "free") +
  theme2use +
  theme(axis.text.x = element_text(angle = 90, hjust = 1),
        title = element_text(size=8),
...
ptypetime = ggplot()+
  geom_line(data = dttype, aes(x = year, y = demtype, color = region, group = region, linetype = scenario))+
  facet_wrap(~type, scales = "free") +
  theme2use +
  theme(axis.text.x = element_text(angle = 90, hjust = 1),
        title = element_text(size=8),
...
if (length(unique(emisys_all$scenario)) == 5 & length(unique(emisys_all$type)) == 2){
p$plotemiregnoliq
