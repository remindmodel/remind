...
vintcomparisonpf = function(dt){
  plot = ggplot()+
    geom_bar(data = dt[year %in% c(2015, 2050, 2100)],
...
## only EU
  regi_EUR = c("ENC","ECS","ESC","ECE","FRA","DEU","UKI","ESW")
...
plot_EU = ggplot()+
    ...
    return(list(plot = plot, plot_EU = plot_EU))
}
...
width <- 22
## indexed to 2015
ggsave("vintages_LDV.jpg", p$plot_EU, dpi=500, height = width* aspect_ratio , width = width, units = "cm")
