...
emisystemcomparison_regi_pf = function(dt, mapping_scens, rp){
  ...
  dt = rbind(dt[variable != "Emi|CO2|Transport|Liquids|WithSynfuels"], dt_liq[variable == "Emi|CO2|Transport|Liquids|WithSynfuels"][, variable := "Emi|CO2|Transport|Liquids"])
...
aspect_ratio <- 1.5
height <- 6
ggsave("emisys.png", p, dpi=500, height = height , width = height * aspect_ratio)
