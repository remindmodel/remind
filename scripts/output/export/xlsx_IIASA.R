...
projects <- list(
  ...
  ScenarioMIP = list(model = "REMIND-MAgPIE 3.5-4.10",
                     ...
                     renameScen = c(
                      "SMIPv07-H-SSP2-rollBack-def" = "SSP2 - High Emissions",
                      "SMIPv07-H-SSP3-rollBack-def" = "SSP3 - High Emissions",
                      "SMIPv07-M-SSP1-NPi2025-def" = "SSP1 - Medium Emissions",
                      "SMIPv07-M-SSP2-NPi2025-def" = "SSP2 - Medium Emissions",
                      "SMIPv07-M-SSP3-NPi2025-def" = "SSP3 - Medium Emissions",
                      "SMIPv07-ML-SSP1-EcPrice190-def" = "SSP1 - Medium-Low Emissions",
                      "SMIPv07-ML-SSP2-EcPrice300-def" = "SSP2 - Medium-Low Emissions",
                      "SMIPv07-ML-SSP3-EcPrice325-def" = "SSP3 - Medium-Low Emissions",
                      "SMIPv07-L-SSP1-EcPrice300-def" = "SSP1 - Low Emissions",
                      "SMIPv07-L-SSP2-EcPrice600-def" = "SSP2 - Low Emissions",
                      "SMIPv07-L-SSP1-EcPrice300-var_yr2035" = "SSP1 - Low Emissions_c",
                      "SMIPv07-L-SSP2-EcPrice600-var_yr2035" = "SSP2 - Low Emissions_c",
                      ...
                      "SMIPv07-VLLO-SSP2-PkPrice500-def" = "SSP2 - Very Low Emissions",
                      "SMIPv07-VLLO-SSP1-PkPrice500-var_yr2035" = "SSP1 - Very Low Emissions_c",
                      "SMIPv07-VLLO-SSP2-PkPrice500-var_yr2035" = "SSP2 - Very Low Emissions_c",
                      NULL
                      ),
                     checkSummation = "ScenarioMIP",
