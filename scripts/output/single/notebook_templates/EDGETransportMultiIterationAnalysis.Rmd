...
Set folder to your fulldata_*.gdx files here
```{r, echo=FALSE, message=FALSE, warning=FALSE}
folder <- "/home/pascal/dev/cluster_tmp/mount/remind/output/BAU_Nash_2021-06-09_16.19.27"
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
sorted_files <- paste0(folder, "/fulldata_", seq_along(files), ".gdx")
