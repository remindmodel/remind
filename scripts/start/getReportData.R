...
getReportData <- function(path_to_report,inputpath_mag="magpie_40",inputpath_acc="costs",var_luc="smooth") {
  ...
  mag2rem <- tribble(
    ...
    "Emissions|CO2|Land|Land-use Change|+|Forest degradation"                         , "co2lucPositive"          ,   1/1000*12/44,
    ...
    "Emissions|CO2|Land|Land-use Change|Peatland|+|Positive"                          , "co2lucPositive"          ,   1/1000*12/44,
    ...
    "Emissions|CO2|Land|Land-use Change|Residual|+|Positive"                          , "co2lucPositive"          ,   1/1000*12/44,
    "Emissions|CO2|Land|Land-use Change|Residual|+|Negative"                          , "co2lucNegUnintent"       ,   1/1000*12/44,
    "Emissions|CO2|Land|Land-use Change|Soil|++|Emissions"                            , "co2lucPositive"          ,   1/1000*12/44,
    "Emissions|CO2|Land RAW|Land-use Change|Soil|Cropland management|+|Withdrawals"   , "co2lucNegUnintent"       ,   1/1000*12/44,
    "Emissions|CO2|Land RAW|Land-use Change|Soil|Land Conversion|+|Withdrawals"       , "co2lucNegUnintent"       ,   1/1000*12/44,
    "Emissions|CO2|Land RAW|Land-use Change|Soil|Soil Carbon Management|+|Withdrawals", "co2lucNegIntentSCM"      ,   1/1000*12/44,
