...
prepare_NDC<-function(gdx, cfg){
  ...
  write.magpie(pm_BAU_reg_emi_wo_LU_bunkers, "./modules/47_regipol/NDC/input/pm_BAU_reg_emi_wo_LU_bunkers.cs4r", comment="** description: Regional GHG emi (excl. LU and bunkers) in BAU scenario \n*** unit: Mt CO2eq/yr \n*** file created with scripts/input/prepare_NDC.R")
  write.magpie(pm_BAU_reg_emi_wo_LU_bunkers, "./modules/48_carbonpriceRegi/NDC/input/pm_BAU_reg_emi_wo_LU_bunkers.cs4r", comment="** description: Regional GHG emi (excl. LU and bunkers) in BAU scenario \n*** unit: Mt CO2eq/yr \n*** file created with scripts/input/prepare_NDC.R")
}
