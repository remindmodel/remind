...
q_windoff_low(t,regi)$(t.val > 2020)..
   ...
   =g=
   p_shareWindOff(t,regi) * p_shareWindPotentialOff2On(regi) * 0.5 * sum(rlf, vm_deltaCap(t,regi,"wind",rlf))
;

q_windoff_high(t,regi)$(t.val > 2020)..
   sum(rlf, vm_deltaCap(t,regi,"windoff",rlf))
   =l=
   p_shareWindOff(t,regi) * p_shareWindPotentialOff2On(regi) * 2 * sum(rlf, vm_deltaCap(t,regi,"wind",rlf))
;
