...
p_GDP_NetNeg_share(regi) = 1;  !! if no value assigned to GLO, default is 100%
p_GDP_NetNeg_share(regi) = f_GDP_NetNeg_share("GLO"); !! if a value is assigned to GLO, this value is set for all regions
loop(ext_regi$f_GDP_NetNeg_share(ext_regi),
    p_GDP_NetNeg_share(regi)$(regi_groupExt(ext_regi, regi)) = f_GDP_NetNeg_share(ext_regi);
  );
