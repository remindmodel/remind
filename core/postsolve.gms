...
p_FE_limit(t,regi,entyFE,sector)$pm_shfetot_up(t,regi,entyFe,sector) = pm_shfetot_up(t,regi,entyFE,sector) * sum(entyFe2FeType(entyFe2,entyFe), v_FE_total.l(t,regi,entyFe2));
