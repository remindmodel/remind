...
o_emissions(ttot,regi,emi)$(ttot.val ge 2015) = sum(emiMkt, vm_emiAllMkt.l(ttot,regi,emi,emiMkt))*emi_conv(emi);

o_emissions_energy(ttot,regi,emi)$(ttot.val ge 2015) = sum(emiMkt, vm_emiTeMkt.l(ttot,regi,emi,emiMkt))*emi_conv(emi);

o_emissions_energy_demand(ttot,regi,emi)$(ttot.val ge 2015) = 
...
o_emissions_energy_demand_sector(ttot,regi,emi,sector)$(ttot.val ge 2015) =
...
o_emissions_energy_supply_gross(ttot,regi,emi)$(ttot.val ge 2015) =
	sum(pe2se(entyPe,entySe,te),
		pm_emifac(ttot,regi,entyPe,entySe,te,emi)
		* vm_demPE.l(ttot,regi,entyPe,entySe,te)
	)*emi_conv(emi);
	
o_emissions_energy_supply_gross_carrier(ttot,regi,emi,entySe)$(ttot.val ge 2015) =
	sum(pe2se(entyPe,entySe,te),
		pm_emifac(ttot,regi,entyPe,entySe,te,emi)
		* vm_demPE.l(ttot,regi,entyPe,entySe,te)
	)*emi_conv(emi);

o_emissions_energy_extraction(ttot,regi,emi,entyPe)$(ttot.val ge 2015) =
...
o_emissions_energy_negative(ttot,regi,emi)$(ttot.val ge 2015) =
	(
...
o_emissions_industrial_processes(ttot,regi,emi)$(ttot.val ge 2015) =
	sum(emiMacSector$(emiMac2sector(emiMacSector,"indst","process",emi)),
			vm_emiMacSector.l(ttot,regi,emiMacSector)
	)*emi_conv(emi);

o_emissions_AFOLU(ttot,regi,emi)$(ttot.val ge 2015) =
	sum(emiMacSector$(emiMac2sector(emiMacSector,"agriculture","process",emi) OR emiMac2sector(emiMacSector,"lulucf","process",emi)),
		vm_emiMacSector.l(ttot,regi,emiMacSector)
	)*emi_conv(emi);
	
o_emissions_DACCS(ttot,regi,emi)$(ttot.val ge 2015) =
	vm_emiCdr.l(ttot,regi,emi)*emi_conv(emi)
;

o_emissions_other(ttot,regi,emi)$(ttot.val ge 2015) =
	pm_emiExog(ttot,regi,emi)*emi_conv(emi)
;

***Carbon Management|Carbon Capture (Mt CO2/yr)
o_capture(ttot,regi,"co2")$(ttot.val ge 2015) =
	sum(teCCS2rlf(te,rlf),
		vm_co2capture.l(ttot,regi,"cco2","ico2","ccsinje",rlf)
	)*emi_conv("co2");

***Carbon Management|Carbon Capture|Process|Energy (Mt CO2/yr)
o_capture_energy(ttot,regi,"co2")$(ttot.val ge 2015) =
...
o_capture_energy_elec(ttot,regi,"co2")$(ttot.val ge 2015) =
...
o_capture_energy_other(ttot,regi,"co2")$(ttot.val ge 2015) =
...
o_capture_cdr(ttot,regi,"co2")$(ttot.val ge 2015) =
...
o_capture_industry(ttot,regi,"co2")$(ttot.val ge 2015) =
	sum(emiInd37,
...
o_capture_energy_bio(ttot,regi,"co2")$(ttot.val ge 2015) =
...
o_capture_energy_fos(ttot,regi,"co2")$(ttot.val ge 2015) =
...
o_carbon_reemitted(ttot,regi,"co2")$(ttot.val ge 2015) =
