...
*JeS* Update tax levels / cumulative GHG emission level (CO2+CH4+N2O, in CO2eq units) to reach the CO2 FF&I budget (s_actualbudgetco2 runs from 2020-2100, not peak budget)
...
*JeS* Update CO2 tax trajectories / cumulative GHG emission level (CO2+CH4+N2O, in CO2eq units) to reach the CO2 budget (s_actualbudgetco2 runs from 2020-2100, not peak budget)
*KK* for a time step of 5 years, the budget is calculated as 3 * 2020 + ts(2025-2090) + 8 * 2100;
*** 10-pm_ts("2090")/2 and pm_ts("2020")/2 are the time periods that haven't been taken into account in the sum over ttot.
*** 0.5 year of emissions is added for the two boundaries, such that the budget is calculated for 81 years.
...
*JeS* Update CO2 tax trajectories / cumulative GHG emission level (CO2+CH4+N2O, in CO2eq units) to reach the peak CO2 budget, without changing temporal profile (i.e. with overshoot)
...
*JeS/CB* Update CO2 tax trajectories / cumulative GHG emission level (CO2+CH4+N2O, in CO2eq units) to reach the peak CO2 budget, but make sure CO2 emissions afterward are close to zero on the global level
