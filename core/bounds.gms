...
*' switch to prevent new capacities of 1st generation biofuel technologies
*' after 2030, allowing more cost-efficient and more sustainable new
...
*** vm_prodFe.fx("2005",regi,se2fe(enty,enty2,te)) = sum(fe2ppfEn(enty2,in), pm_cesdata("2005",regi,in,"quantity") );
  vm_deltaCap.up(t,regi,"coalgas",rlf)$(t.val gt 2010) = 0.00001;
$endif
