...
vm_demFeSector_afterTax(ttot,all_regi,all_enty,all_enty,emi_sectors,all_emiMkt) "auxiliar variable to track marginal tax effects on FE balance equations. FE demand per sector and emission market. [TWa]"
