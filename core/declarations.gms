...
***----------------------------------------------------------------------------------------
***-----------------------------------------------ESM module-------------------------------
pm_emiExog(tall,all_regi,emiTe)                     "exogenous emissions"
...
vm_emiAllGlob(ttot,emiTe)                         "total global emissions - link to the climate module. [GtC, Mt CH4, Mt N]"
...
o_emissions_energy_demand(ttot,all_regi,emiTe)   "output parameter"
o_emissions_energy_demand_sector(ttot,all_regi,emiTe,emi_sectors)   "output parameter"
o_emissions_energy_supply_gross(ttot,all_regi,emiTe)   "output parameter"
o_emissions_energy_supply_gross_carrier(ttot,all_regi,emiTe,all_enty)   "output parameter"
o_emissions_energy_extraction(ttot,all_regi,emiTe,all_enty)   "output parameter"
o_emissions_energy_negative(ttot,all_regi,emiTe)   "output parameter"
o_emissions_industrial_processes(ttot,all_regi,emiTe)   "output parameter"
o_emissions_AFOLU(ttot,all_regi,emiTe)   "output parameter"
o_emissions_DACCS(ttot,all_regi,emiTe)   "output parameter"
o_emissions_other(ttot,all_regi,emiTe)   "output parameter"

o_capture(ttot,all_regi,emiTe)   "output parameter"
o_capture_energy(ttot,all_regi,emiTe)   "output parameter"
o_capture_energy_elec(ttot,all_regi,emiTe)   "output parameter"
o_capture_energy_other(ttot,all_regi,emiTe)   "output parameter"
o_capture_cdr(ttot,all_regi,emiTe)   "output parameter"
o_capture_industry(ttot,all_regi,emiTe)   "output parameter"
o_capture_energy_bio(ttot,all_regi,emiTe)   "output parameter"
o_capture_energy_fos(ttot,all_regi,emiTe)   "output parameter"
o_carbon_CCU(ttot,all_regi,emiTe)   "output parameter"
o_carbon_LandUse(ttot,all_regi,emiTe)   "output parameter"
o_carbon_underground(ttot,all_regi,emiTe)   "output parameter"
o_carbon_reemitted(ttot,all_regi,emiTe)   "output parameter"

o_emi_conv(emiTe)    "output parameter" / co2 3666.6666666666666666666666666667, ch4 28, n2o 416.4286, so2 1,	bc  1, oc  1 /
;
