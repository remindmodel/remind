...
p_FeTot(ttot,all_regi,all_enty,sector,all_emiMkt)                 "total FE summed over all SE carrier origins"
p_FeSeShare(ttot,all_regi,all_enty,all_enty,sector,all_emiMkt)    "share of SE origin in FE"
